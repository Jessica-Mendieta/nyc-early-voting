const config = {
    ...
    description: "Early voting runs from Saturday, October 24 to Sunday, November 1. Type an address to sort the list of poll sites by distance, or filter by borough, and verify your poll site at findmypollsite.vote.nyc",
